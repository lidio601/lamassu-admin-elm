...
var _user$project$Pair$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Loading 1234...')
			]));
};
...
var _user$project$Pair$init = {
	ctor: '_Tuple2',
	_0: {totem: _elm_lang$core$Maybe$Nothing},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Pair$Model = function (a) {
	return {totem: a};
};
var _user$project$Pair$None = {ctor: 'None'};
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {page: a, pair: b};
	});
var _user$project$Main$PairPage = {ctor: 'PairPage'};
var _user$project$Main$pageParser = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Main$PairPage,
			_evancz$url_parser$UrlParser$s(''))
		]));
var _user$project$Main$parser = function (location) {
	return A3(_evancz$url_parser$UrlParser$parse, _elm_lang$core$Basics$identity, _user$project$Main$pageParser, location.pathname);
};
var _user$project$Main$init = function (result) {
	var _p2 = _user$project$Pair$init;
	var pairModel = _p2._0;
	return A2(
		_user$project$Main$urlUpdate,
		result,
		{page: _user$project$Main$PairPage, pair: pairModel});
};
...
var _user$project$Main$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(_user$project$Main$parser),
