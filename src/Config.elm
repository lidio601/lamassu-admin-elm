...
updateInputInstance : InputInstance -> FieldScope -> String -> InputInstance
updateInputInstance inputInstance fieldScope value =
    case inputInstance of
        FieldStringInstance fieldRec ->
            { fieldRec | value = toFieldHolder identity value }

        FieldPercentageInstance fieldRec ->
            { fieldRec | value = toFieldHolder String.toFloat value }
            ...
            updateWhen (((==) fieldLocator.fieldScope) << .fieldScope)
                (case generalInstance of
                    FieldInputInstance instance ->
                        (updateInputInstance instance fieldLocator.fieldScope valueString)
